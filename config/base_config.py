...
# Login type: read from env, auto-detect XHS_WEB_SESSION
_login_type = os.getenv("LOGIN_TYPE", "qrcode")
_cookies = os.getenv("COOKIES", "")
_xhs_session = os.getenv("XHS_WEB_SESSION", "")
if _xhs_session and not _cookies:
    _cookies = f"web_session={_xhs_session}"
    _login_type = "cookie"
LOGIN_TYPE = _login_type  # qrcode or phone or cookie
COOKIES = _cookies
